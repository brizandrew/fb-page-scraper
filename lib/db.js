...
function updatePostData(data){
    ...
    return new Promise((resolve, reject) => {
        conn.query(query, Object.values(data), function (error) {
            if (error){
                reject(error);
            }
...
export default { endConnection, updatePages, getPages, addPosts, getPosts, updatePostData, getNewLinks, getAllData, deletePosts };
